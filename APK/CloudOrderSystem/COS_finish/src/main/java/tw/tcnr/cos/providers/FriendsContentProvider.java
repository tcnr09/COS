...
public class FriendsContentProvider extends ContentProvider {
    private static final String AUTHORITY = "tw.tcnr.cos.providers";
    private static final String DB_FILE = "friends.db", DB_TABLE = "recordtest";
    ...
    private static final String crTBsql = "CREATE TABLE " + DB_TABLE + " ( "
            + "recordID INTEGER PRIMARY KEY," + "Date TEXT NOT NULL," + "Item TEXT,"+ "Price TEXT,"
            + "Tel TEXT);";
