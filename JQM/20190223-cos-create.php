...
<head>
	...
	<script>
		var usernameFlag,passwordFlag,repwdFlag,telFlag;
		$(function(){
			// 帳號
			...
			$("#reg_ok").bind("click", function(){
				$.ajax({
					type: "POST",
					// url: "http://192.168.60.117/mobileWEB/memberAPI/20190223-cos-create-api.php",
					url: "http://192.168.60.120/20190223/memberAPI/member-CURD-api.php",
		...
		function reg(data){
			if(data == 1){
				location.href = "http://192.168.60.120/20190223/20190223-member-login.php";
			}else{
				alert(data);
			}										
		}
